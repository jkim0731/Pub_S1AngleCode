...
function H = makePlot(x,y,errBar,lineProps,transparent,patchSaturation)
    ...
    if transparent
%         if patchSaturation == 1 % 2019/09/12 JK. To work with export_fig, exporting in eps in vector
%             faceAlpha = 0.99; 
%         else
...
%         end
        ...
        faceAlpha=1;
%         faceAlpha=0.99; % 2019/09/12 JK. To work with export_fig, exporting in eps in vector
